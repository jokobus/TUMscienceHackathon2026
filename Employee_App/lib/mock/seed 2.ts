...
export const students: StudentRef[] = [
  { id: "stu-1", displayName: "Nakulan Sivananthan", university: "TU München", studyDegree: "M.Sc. Electrical Engineering" },
...
export const attendeesByEvent: Record<string, Attendee[]> = {
  "evt-3": [
    { userId: "stu-1", displayName: "Nakulan Sivananthan", university: "TU München", studyDegree: "M.Sc. EE", checkedInAt: "2026-06-19T08:12:00Z", fullSession: false, leadStatus: "qualified" },
  ...
  "evt-1": [
    { userId: "stu-1", displayName: "Nakulan Sivananthan", university: "TU München", studyDegree: "M.Sc. EE", checkedInAt: "2026-03-11T10:02:00Z", fullSession: true, leadStatus: "qualified" },
...
export const interactionsByEvent: Record<string, Interaction[]> = {
  "evt-3": [
    { id: "i-301", eventId: "evt-3", userId: "stu-1", userName: "Nakulan Sivananthan", type: "check_in", timestamp: "2026-06-19T08:12:00Z" },
    { id: "i-302", eventId: "evt-3", userId: "stu-1", userName: "Nakulan Sivananthan", type: "project_interest", timestamp: "2026-06-19T13:40:00Z" },
    ...
    { id: "i-308", eventId: "evt-3", userId: "stu-1", userName: "Nakulan Sivananthan", type: "memory_post", timestamp: "2026-06-20T12:02:00Z" },
  ],
  "evt-1": [
    { id: "i-101", eventId: "evt-1", userId: "stu-1", userName: "Nakulan Sivananthan", type: "check_in", timestamp: "2026-03-11T10:02:00Z" },
    { id: "i-102", eventId: "evt-1", userId: "stu-1", userName: "Nakulan Sivananthan", type: "career_interest", timestamp: "2026-03-11T10:40:00Z" },
    ...
    { id: "i-107", eventId: "evt-1", userId: "stu-1", userName: "Nakulan Sivananthan", type: "recommendation_submitted", timestamp: "2026-03-13T16:00:00Z" },
  ],
  "evt-8": [
...
export const chats: ChatSummary[] = [
  ...
  { id: "dm-naku", type: "dm", title: "Nakulan Sivananthan", subtitle: "TU München · M.Sc. EE", lastMessage: "Thanks! I'll send the schematic over.", lastMessageAt: "2026-06-20T09:50:00Z", unread: 1, liveHighlight: false },
...
export const messagesByChat: Record<string, Message[]> = {
  "chat-evt3": [
    ...
    { id: "msg-e3-2", chatId: "chat-evt3", senderUserId: "stu-1", senderName: "Nakulan Sivananthan", body: "Where can we grab extra dev boards?", sentAt: "2026-06-19T10:20:00Z" },
  ...
  "dm-naku": [
    { id: "msg-n-1", chatId: "dm-naku", senderUserId: "stu-1", senderName: "Nakulan Sivananthan", body: "Hi Simon, quick question on the GaN half-bridge layout.", sentAt: "2026-06-20T09:40:00Z" },
    ...
    { id: "msg-n-3", chatId: "dm-naku", senderUserId: "stu-1", senderName: "Nakulan Sivananthan", body: "Thanks! I'll send the schematic over.", sentAt: "2026-06-20T09:50:00Z" },
  ],
  "dm-thivi": [
